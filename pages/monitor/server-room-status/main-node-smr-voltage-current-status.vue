<template>
  <v-row>
    ...
    <v-col class="text-center" :cols="12" :md="6">
      <chart-card title="主節點SMR電壓與電流狀態統計圖">
    ...
    <v-col class="text-center" :cols="12" :md="6">
      <chart-card title="主節點SMR電壓與電流狀態趨勢圖">
    ...
    <v-col :cols="12">
      <table-card title="機房環境狀態-主節點SMR電壓與電流狀況" :items="items">
        <template
          #default="{
            search,
            footerProps,
...
import items from '~/assets/json/smr-load-status.json';
