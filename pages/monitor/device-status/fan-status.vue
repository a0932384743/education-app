<template>
  <v-row>
    ...
    <v-col :cols="12">
      <table-card title="設備狀態-設備風扇狀態" :items="items">
        <template
          #default="{
            search,
            footerProps,
          ...
          >
            ...
            <template #[`item.fanStatus`]="{ item }">
              ...
              >
                <g>
                  <path
                    d="M162.466,137.052c7.732-7.119,39.268-38.192,36.846-69.387c-2.057-26.462-32.63-34.426-49.585-34.426
		...
		C154.52,131.333,159.182,133.54,162.466,137.052z"
                  />
                  <path
                    d="M131.332,149.333c0-3.023,0.754-5.867,2.07-8.369c-11.169-3.415-52.577-14.314-77.824,3
		...
		C137.573,165.362,131.332,158.08,131.332,149.333z"
                  />
                  <path
                    d="M243.072,144.464c-25.053-17.181-66.036-6.541-77.584-3.028c1.169,2.387,1.844,5.061,1.844,7.897
		...
		C256.604,189.878,264.961,159.477,243.072,144.464z"
                  />
                  <path
                    d="M149.333,0C66.99,0,0,66.99,0,149.333s66.99,149.333,149.333,149.333s149.333-66.99,149.333-149.333S231.676,0,149.333,0z
...
<script>
import items from '~/assets/json/device-fan-status.json';
import lineData from '~/assets/json/fan-status-history.json';
