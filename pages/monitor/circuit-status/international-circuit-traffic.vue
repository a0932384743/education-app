<template>
  <v-row>
    <v-col class="text-center" :cols="12" :md="6">
      <chart-card title="國際電路流量狀態監控統計圖">
    ...
    <v-col :cols="12">
      <table-card title="電路狀態-國際電路流量狀況" :items="items">
        <template
          #default="{
            search,
            footerProps,
...
export default {
  name: 'InternationalCircuitTraffic',
  components: { ChartCard , SmallLineChart },
  layout: 'admin-layout',
  data() {
    return {
      statusMap,
